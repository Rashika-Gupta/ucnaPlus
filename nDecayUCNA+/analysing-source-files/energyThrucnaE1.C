...
void energyThrucnaE1(){
    ...
    //file0.open("/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/DELucnaP_Ethr1_Type0.txt");
     fileCheck.open("/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/n_ucna_Ethr1_check.txt");
    
 sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/n_ucna_Ethr1.root");
