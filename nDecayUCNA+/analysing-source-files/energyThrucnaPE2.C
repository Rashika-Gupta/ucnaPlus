...
void energyThrucnaPE2(){
  ...
  //  fileCheck.open("/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/DELucnaP_Ethr2_check.txt");
      sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/n_ucnap_Ethr2_5binwidth.root");
    Double_t E_thr = 20;
