...
// sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/ucnaPlus/nDecayUCNA+/ucnaP-5kevbinwidth10kevEthr.root");
    sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/ucnaPlus/nDecayUCNA+/ucnaP_asymmetry.root");
...
//////v///
   ...
   ////     std::cout<<" E1 : "<<E1 <<" E2 : "<<E2<<endl;
    ...
    //    }
// d//eposits energy on detector 2 type 0 
    //    if(E1 == 0 && E2 != 0){
    ...
    //        }
    //    }
// d//eposits energy on detector 1 type 0 
    //    if(E2 == 0 && E1 != 0){
    //       
	//	 EdepType01->Fill(E1);
    //     pz01->Fill(pZe);
