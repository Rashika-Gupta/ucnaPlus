...
void energyThrucnaPE3_20binwidth(){
    Char_t temp[200];
    std::string filename ; 
    ...
    sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/ucnaPlus/nDecayUCNA+/ucnaP_asymmetry_eventGenChanged_80Million_includingAllType_binwidth20kev_Ethr30.root");
