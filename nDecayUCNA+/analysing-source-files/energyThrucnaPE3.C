...
void energyThrucnaPE3(){
   ...
   // fileCheck.open("/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/DELucnaP_Ethr3_check.txt");
      sprintf(temp, "/mnt/gpfs3_amd/scratch/rgu245/Now/nDecayUCNA+/n_ucnap_Ethr3.root");
    Double_t E_thr = 30;
