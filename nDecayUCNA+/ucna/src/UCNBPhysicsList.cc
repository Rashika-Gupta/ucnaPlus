...
//	theRayleigh->SetModel(new G4LivermoreRayleighModel());  //not strictly necessary
	...
	eIonisation->SetEmModel(new G4LivermoreIonisationModel()); //commented on 12th Sept 2023
...
void UCNBPhysicsList::SetCuts()
{
  ...
  //
  SetCutsWithDefault();
  SetParticleCuts(0.25*um,G4Electron::Electron());  // STANDARD CUT - reduced to half
