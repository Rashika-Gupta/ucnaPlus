...
//-----------------------------------------------------------------------------
  ...
  Tout->Branch("dEeMWPC1", &dEeMWPC1, "dEeMWPC1/D");
  Tout->Branch("dEeMWPC2", &dEeMWPC2, "dEeMWPC2/D");
//
...
void UCNBAnalysisManager::AddUpElectronMWPC1EnergyDeposition(G4double x)
{
  dEeMWPC1 = dEeMWPC1 + x;
}
void UCNBAnalysisManager::AddUpElectronMWPC2EnergyDeposition(G4double x)
{
  dEeMWPC2 = dEeMWPC2 + x;
}
