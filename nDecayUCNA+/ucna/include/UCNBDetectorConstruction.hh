...
//  G4Box*             Dead1Box;
 ...
 // G4Box*             Dead2Box;
  ...
  G4Tubs*            mwpc1;
  G4LogicalVolume*   logicalmwpc1;
  G4VPhysicalVolume* physicalmwpc1;

  G4Tubs*            mwpc2;
  G4LogicalVolume*   logicalmwpc2;
  G4VPhysicalVolume* physicalmwpc2;

  G4Tubs*            mwpc1_enter;
  G4LogicalVolume*   logicalmwpc1_enter;
  G4VPhysicalVolume* physicalmwpc1_enter;

  G4Tubs*            mwpc2_enter;
  G4LogicalVolume*   logicalmwpc2_enter;
  G4VPhysicalVolume* physicalmwpc2_enter;

  G4Tubs*            pentaneVol;
  G4LogicalVolume*   logicalpentaneVol;
  G4VPhysicalVolume* physicalpentaneVol;

  G4Tubs*            pentaneVol2;
  G4LogicalVolume*   logicalpentaneVol2;
  G4VPhysicalVolume* physicalpentaneVol2;
